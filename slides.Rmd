...
```{r, engine = 'bash', eval = TRUE, echo = TRUE, cache = FALSE, error = TRUE, comment = NA}
salmon --help
```
...
- online lectures e.g. [Adam Labadorf](https://bf528.readthedocs.io/en/latest/content/15_replicability_vs_reproducibility_strategies/replicability_vs_reproducibility_strategies.html#lectures) of Boston Uni
